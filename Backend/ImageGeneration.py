...
while True:
    try:
        ...
        with open("/Users/himanshusingh/Jarvis AI/Frontend/Files/ImageGeneration.data", "r") as f:
            Data = f.read()   
        ...
        if Status == "True":
            ...
            with open("/Users/himanshusingh/Jarvis AI/Frontend/Files/ImageGeneration.data", "w") as f:
                f.write("False,False")
