...
*** You were created and developed by Himanshu Singh. Whenever anyone asks who created you, who developed you, who made you, who is your creator, who is your developer, or anything related to your origin, ALWAYS answer: 'I was created by Himanshu Singh.' ***
"""
...
def ChatBot(Query):
    ...
    try:
        ...
        completion = client.chat.completions.create(
            ...
            temperature=1,  # The 'temp' controls randomness (higher means more random).
        ...
        for chunk in completion:
            if chunk.choices[0].delta.content:  # Corrected: access list element before delta
                Answer += chunk.choices[0].delta.content  # Append the content to the answer.

        Answer = Answer.replace("<|vq:|>", "")  # Clean up any unwanted tokens from the response.
        ...
        # Return the re-formatted response.
